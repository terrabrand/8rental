...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Invoice Recurring
    Route::delete('invoice-recurrings/destroy', 'InvoiceRecurringController@massDestroy')->name('invoice-recurrings.massDestroy');
    Route::post('invoice-recurrings/parse-csv-import', 'InvoiceRecurringController@parseCsvImport')->name('invoice-recurrings.parseCsvImport');
    Route::post('invoice-recurrings/process-csv-import', 'InvoiceRecurringController@processCsvImport')->name('invoice-recurrings.processCsvImport');
    Route::resource('invoice-recurrings', 'InvoiceRecurringController');

    // Application Settings
    Route::delete('application-settings/destroy', 'ApplicationSettingsController@massDestroy')->name('application-settings.massDestroy');
    Route::post('application-settings/media', 'ApplicationSettingsController@storeMedia')->name('application-settings.storeMedia');
    Route::post('application-settings/ckmedia', 'ApplicationSettingsController@storeCKEditorImages')->name('application-settings.storeCKEditorImages');
    Route::resource('application-settings', 'ApplicationSettingsController');

    // Hero Section
    Route::delete('hero-sections/destroy', 'HeroSectionController@massDestroy')->name('hero-sections.massDestroy');
    Route::post('hero-sections/media', 'HeroSectionController@storeMedia')->name('hero-sections.storeMedia');
    Route::post('hero-sections/ckmedia', 'HeroSectionController@storeCKEditorImages')->name('hero-sections.storeCKEditorImages');
    Route::resource('hero-sections', 'HeroSectionController');

    // Features Section
    Route::delete('features-sections/destroy', 'FeaturesSectionController@massDestroy')->name('features-sections.massDestroy');
    Route::post('features-sections/media', 'FeaturesSectionController@storeMedia')->name('features-sections.storeMedia');
    Route::post('features-sections/ckmedia', 'FeaturesSectionController@storeCKEditorImages')->name('features-sections.storeCKEditorImages');
    Route::resource('features-sections', 'FeaturesSectionController');
