...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.units.update", [$unit->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="unit_property_id">{{ trans('cruds.unit.fields.unit_property') }}</label>
                <select class="form-control select2 {{ $errors->has('unit_property') ? 'is-invalid' : '' }}" name="unit_property_id" id="unit_property_id" required>
                    @foreach($unit_properties as $id => $entry)
                        <option value="{{ $id }}" {{ (old('unit_property_id') ? old('unit_property_id') : $unit->unit_property->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('unit_property'))
                    <div class="invalid-feedback">
                        {{ $errors->first('unit_property') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.unit.fields.unit_property_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('unit_section') ? 'is-invalid' : '' }}" name="unit_section_id" id="unit_section_id">
                    @foreach($unit_sections as $id => $entry)
                        <option value="{{ $id }}" {{ (old('unit_section_id') ? old('unit_section_id') : $unit->unit_section->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('unit_section'))
                    <div class="invalid-feedback">
                        {{ $errors->first('unit_section') }}
                    </div>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rent_price') ? 'is-invalid' : '' }}" type="number" name="rent_price" id="rent_price" value="{{ old('rent_price', $unit->rent_price) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_size') ? 'is-invalid' : '' }}" type="text" name="unit_size" id="unit_size" value="{{ old('unit_size', $unit->unit_size) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_bedrooms') ? 'is-invalid' : '' }}" type="number" name="number_of_bedrooms" id="number_of_bedrooms" value="{{ old('number_of_bedrooms', $unit->number_of_bedrooms) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_kitchens') ? 'is-invalid' : '' }}" type="number" name="number_of_kitchens" id="number_of_kitchens" value="{{ old('number_of_kitchens', $unit->number_of_kitchens) }}" step="1">
                @if($errors->has('number_of_kitchens'))
                    <div class="invalid-feedback">
                        {{ $errors->first('number_of_kitchens') }}
                    </div>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_bathrooms') ? 'is-invalid' : '' }}" type="number" name="number_of_bathrooms" id="number_of_bathrooms" value="{{ old('number_of_bathrooms', $unit->number_of_bathrooms) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('market_rent') ? 'is-invalid' : '' }}" type="number" name="market_rent" id="market_rent" value="{{ old('market_rent', $unit->market_rent) }}" step="0.01">
                @if($errors->has('market_rent'))
                    <div class="invalid-feedback">
                        {{ $errors->first('market_rent') }}
                    </div>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deposit_amount') ? 'is-invalid' : '' }}" type="number" name="deposit_amount" id="deposit_amount" value="{{ old('deposit_amount', $unit->deposit_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('parking_type') ? 'is-invalid' : '' }}" name="parking_type" id="parking_type">
                    ...
                    @foreach(App\Models\Unit::PARKING_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('parking_type', $unit->parking_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $unit->notes) }}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
