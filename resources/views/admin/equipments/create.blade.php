    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.equipments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('model_number') ? 'is-invalid' : '' }}" type="text" name="model_number" id="model_number" value="{{ old('model_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('warranty_expiration') ? 'is-invalid' : '' }}" type="text" name="warranty_expiration" id="warranty_expiration" value="{{ old('warranty_expiration') }}">
                @if($errors->has('warranty_expiration'))
                    <div class="invalid-feedback">
                        {{ $errors->first('warranty_expiration') }}
                    </div>
                @endif
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('equipment_details') ? 'is-invalid' : '' }}" name="equipment_details" id="equipment_details">{{ old('equipment_details') }}</textarea>
                @if($errors->has('equipment_details'))
                    <div class="invalid-feedback">
                        {{ $errors->first('equipment_details') }}
                    </div>
                @endif
