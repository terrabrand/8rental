    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hero-sections.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_title') ? 'is-invalid' : '' }}" type="text" name="main_title" id="main_title" value="{{ old('main_title', 'All in one sass application for your business') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_title_description') ? 'is-invalid' : '' }}" type="text" name="main_title_description" id="main_title_description" value="{{ old('main_title_description', 'No coding required to make customisations. The live customiser has everything your marketing need.') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_button_title') ? 'is-invalid' : '' }}" type="text" name="main_button_title" id="main_button_title" value="{{ old('main_button_title', 'Get Early Access') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('main_button_link') ? 'is-invalid' : '' }}" type="text" name="main_button_link" id="main_button_link" value="{{ old('main_button_link', 'https://themeselection.com/item/category/free-admin-templates/') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\HeroSection::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', 'YES') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
