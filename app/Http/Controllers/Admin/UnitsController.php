...
class UnitsController extends Controller
{
    ...
    public function index()
    {
        ...
        $units = Unit::with(['unit_property', 'unit_section', 'media'])->get();
    ...
    public function create()
    {
        ...
        $unit_properties = Property::pluck('property_name', 'id')->prepend(trans('global.pleaseSelect'), '');

        $unit_sections = Section::pluck('section_name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.units.create', compact('unit_properties', 'unit_sections'));
    }
    ...
    public function edit(Unit $unit)
    {
        ...
        $unit->load('unit_property', 'unit_section');

        return view('admin.units.edit', compact('unit', 'unit_properties', 'unit_sections'));
    }
    ...
    public function show(Unit $unit)
    {
        ...
        $unit->load('unit_property', 'unit_section', 'unitApplyingApplications', 'unitInvoiceRecurrings', 'unitExpenses', 'unitDocuments', 'unitInvoices');
