...
class PropertiesController extends Controller
{
    ...
    public function index()
    {
        ...
        $properties = Property::with(['landlord', 'tenants', 'maintainer', 'media'])->get();

        $landlords = Landlord::get();

        $tenants = Tenant::get();

        $maintainers = Maintainer::get();

        return view('admin.properties.index', compact('landlords', 'maintainers', 'properties', 'tenants'));
    }
    ...
    public function create()
    {
        ...
        $maintainers = Maintainer::pluck('email', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.properties.create', compact('landlords', 'maintainers', 'tenants'));
    }
    ...
    public function edit(Property $property)
    {
        ...
        $property->load('landlord', 'tenants', 'maintainer');

        return view('admin.properties.edit', compact('landlords', 'maintainers', 'property', 'tenants'));
    }
    ...
    public function show(Property $property)
    {
        ...
        $property->load('landlord', 'tenants', 'maintainer', 'propertySections', 'unitPropertyUnits', 'propertyTenants', 'propertyApplyingApplications', 'propertyInvoiceRecurrings', 'propertyExpenses', 'propertyDocuments', 'propertyInvoices');
