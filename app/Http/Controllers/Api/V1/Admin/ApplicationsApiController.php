...
class ApplicationsApiController extends Controller
{
    public function index()
    {
        ...
        return new ApplicationResource(Application::with(['user', 'property_applying', 'unit_applying'])->get());
    }
    ...
    public function show(Application $application)
    {
        ...
        return new ApplicationResource($application->load(['user', 'property_applying', 'unit_applying']));
    }
