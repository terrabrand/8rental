...
class Unit extends Model implements HasMedia
{
    ...
    public function unitInvoiceRecurrings()
    {
        return $this->hasMany(InvoiceRecurring::class, 'unit_id', 'id');
    }
    ...
    public function unit_property()
    {
        return $this->belongsTo(Property::class, 'unit_property_id');
    }
